...
void storeNewRecord(State_t* State, Date_t* Date, Date_t* Date_Snapshot);  // Stores a new record, either on an external EEPROM chip or an array in RAM. Designed for Microchip's 25LC1024 SPI Serial EEPROM
