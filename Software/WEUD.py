def WEUD(csvRecord):
    ...
    #################################################################################
    #DATA#
    #csvRecord = str('/home/pi/Software3/data/Logger.csv')
    ...
    data = pd.read_csv(csvRecord,index_col ='Time',parse_dates = ['Time'], date_parser=dateparse, skiprows = 3)
    ...
    newcsv = csvRecord[:-4] + '-DISAGGREGATED.csv'
    Events.to_csv(newcsv, index = None, header=True)
